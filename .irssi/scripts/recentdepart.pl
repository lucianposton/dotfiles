...
Irssi::settings_add_int("recdentpepart", "recdep_period", 3600);
Irssi::settings_add_int("recdentpepart", "recdep_rejoin", 3600);
Irssi::settings_add_int("recdentpepart", "recdep_nickperiod", 3600);
